...
//        // Itérations sur la profondeur de l'algorithme utilisé par le joueur blanc
...
//                } else {
//                    if (jnum == 0) {
//                        tabBilan[profondeurMax - 1] = "PERDU";
//                    } else {
//                        tabBilan[profondeurMax - 1] = "GAGNE";
//                    }
...
//        /************* BILAN **********/
//        System.out.println("\nBILAN DES MATCHS :\n");
//        for (int profondeur = 1; profondeur < 10; profondeur++) {
//            System.out.println("JBlanc(Minimax horizon " + profondeur + ") VS JNoir(Minimax horizon 4) : "
//                    + tabBilan[profondeur - 1]);
//        }
//    }
//}
public class PartieDominos {
    ...
    public static void main(String[] args) {
      ...
      // Itérations sur la profondeur de l'algorithme utilisé par le joueur blanc
        ...
        System.out.println("\nBILAN DES MATCHS :\n");
        for (int profondeur = 1; profondeur < 10; profondeur++) {
            System.out.println("JBlanc(Alphabeta horizon " + profondeur + ") VS JNoir(Minimax horizon 4) : "
                    + tabBilan[profondeur - 1]);
        }
    }
}
